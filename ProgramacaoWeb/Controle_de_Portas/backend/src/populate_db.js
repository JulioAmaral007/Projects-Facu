...
const usuarios = [
  {
    idufsc: 'admin',
    senha: 'admin',
    salas: ['C-120', 'C-124', 'A-316', 'A-317', 'A-117', 'A-205'],
  },
  {
    idufsc: 'Clark_Kent',
    senha: 'KWpoiuwex',
    salas: ['C-120', 'C-124', 'A-316'],
  },
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZHVmc2MiOiJhZG1pbiIsImlhdCI6MTczNTQ5NDYyNSwiZXhwIjoxNzM1NDk4MjI1fQ.wGBRlVQNAhgwtMoOes7jHFxO5ePve7uJiCR8-WBKwkc
